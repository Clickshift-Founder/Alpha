// ClickShift Alpha - Interactive Token Analyzer
// The world's first predictive trading intelligence platform
...
async function analyzeOrderBook(tokenData) {
   console.log('\n🔍 Analyzing Order Book & Alpha Patterns...');
...
function displayAnalysis(tokenData, analysis) {
   console.log('\n' + '='.repeat(70));
   console.log('🚀 CLICKSHIFT ALPHA - INTELLIGENCE REPORT');
   console.log('='.repeat(70));
   
   // Alpha Signals
   console.log(`\n🚀 ALPHA POTENTIAL: ${analysis.pumpSignals.potential} (${analysis.pumpSignals.score}/100)`);
   if (analysis.pumpSignals.signals.length > 0) {
       console.log('Alpha Indicators:');
       analysis.pumpSignals.signals.forEach(signal => console.log(`  ${signal}`));
   } else {
       console.log('  No strong alpha indicators detected');
   }
   ...
   // Exit Clusters with Market Cap Projections
   console.log('\n🎯 TOP EXIT CLUSTERS:');
   ...
   // Trading Recommendation with Alpha Signals
   console.log('\n💎 ALPHA STRATEGY RECOMMENDATION:');
   
   // Entry recommendations based on alpha signals
   if (analysis.pumpSignals.potential === 'VERY HIGH' || analysis.pumpSignals.potential === 'HIGH') {
       console.log('🟢 ALPHA OPPORTUNITY DETECTED:');
       console.log(`  • Alpha potential: ${analysis.pumpSignals.potential}`);
       console.log(`  • Consider entering on dips with tight risk management`);
       console.log(`  • Watch for breakout above resistance levels`);
   }
   
   // Risk-based recommendations
   if (analysis.riskAssessment.level === 'LOW') {
       console.log('✅ Relatively safe for alpha plays. Monitor whale activity and exit clusters.');
...
function showMenu() {
   console.log('\n' + '='.repeat(60));
   console.log('🚀 CLICKSHIFT ALPHA - PREDICTIVE INTELLIGENCE');
   console.log('='.repeat(60));
   console.log('1. Analyze a token (paste contract address)');
   console.log('2. Quick alpha check: BONK');
   console.log('3. Quick alpha check: WIF');
   console.log('4. Exit');
   console.log('='.repeat(60));
}
   ...
   switch(choice.trim()) {
       case '1':
           rl.question('\n📋 Paste the Solana contract address: ', async (address) => {
               ...
               console.log(`\n🔍 Running Alpha Analysis: ${cleanAddress}`);
       ...
       case '4':
           console.log('\n👋 Thanks for using ClickShift Alpha!');
           console.log('💎 Join our community for exclusive alpha: @ClickShiftAlerts');
           rl.close();
           break;
...
function startApp() {
   console.log('🎉 Welcome to ClickShift Alpha!');
   console.log('💎 Predictive Trading Intelligence Platform');
   console.log('🚀 Get exclusive alpha on crypto trades');
   showMenuAndWait();
}
